...
(function(l) {
    ...
    var E = function() {
        ...
        return Object.defineProperty(h.prototype, "isWindows", {
            get: function() {
            ...
            this._detected || (this._detected = !0, this._isWindows = h._isWindows(), this._isNode = typeof module != "undefined" && !!module.exports, this._isElectronRenderer = typeof process != "undefined" && typeof process.versions != "undefined" && typeof process.versions.electron != "undefined" && process.type === "renderer", this._isWebWorker = typeof l.global.importScripts == "function")
...
(function(l) {
    ...
    var h = function() {
        ...
        return a.prototype.record = function(n, p) {
...
(function(l) {
    var E = function() {
        function h() {}
        return h.fileUriToFilePath = function(_, a) {
            ...
            if (!_ || typeof _ != "object" || _ instanceof RegExp || !Array.isArray(_) && Object.getPrototypeOf(_) !== Object.prototype) return _;
        ...
        }, h.NEXT_ANONYMOUS_ID = 1, h.PERFORMANCE_NOW_PROBED = !1, h.HAS_PERFORMANCE_NOW = !1, h
    }();
    l.Utilities = E
})(AMDLoader || (AMDLoader = {}));
var AMDLoader;
    ...
    var h = function() {
        ...
        return a.validateConfigurationOptions = function(n) {
            ...
            return l.Utilities.forEachProperty(n, function(e, t) {
                e === "ignoreDuplicateModules" && typeof r.ignoreDuplicateModules != "undefined" ? r.ignoreDuplicateModules = r.ignoreDuplicateModules.concat(t) : e === "paths" && typeof r.paths != "undefined" ? l.Utilities.forEachProperty(t, function(i, o) {
                    return r.paths[i] = o
                }) : e === "config" && typeof r.config != "undefined" ? l.Utilities.forEachProperty(t, function(i, o) {
                    return r.config[i] = o
    ...
    var _ = function() {
        ...
        return a.prototype._createIgnoreDuplicateModulesMap = function() {
            ...
            for (var p, r = 0, e = this.sortedPathsRules.length; r < e; r++)
                if (p = this.sortedPathsRules[r], l.Utilities.startsWith(n, p.from)) {
            ...
            if (this.options.urlArgs)
                for (var p = 0, r = n.length; p < r; p++) n[p] = this._addUrlArgsToUrl(n[p]);
            return n
            ...
            if (!l.Utilities.endsWith(r, ".js") && !l.Utilities.isAbsolutePath(r)) {
                ...
                for (var t = 0, i = e.length; t < i; t++) this.isBuild() && e[t] === "empty:" || (l.Utilities.isAbsolutePath(e[t]) || (e[t] = this.options.baseUrl + e[t]), !l.Utilities.endsWith(e[t], ".js") && !l.Utilities.containsQueryString(e[t]) && (e[t] = e[t] + ".js"))
            } else !l.Utilities.endsWith(r, ".js") && !l.Utilities.containsQueryString(r) && (r = r + ".js"), e = [r];
            return this._addUrlArgsIfNecessaryToUrls(e)
        }, a.prototype.requireToUrl = function(n) {
            var p = n;
            return l.Utilities.isAbsolutePath(p) || (p = this._applyPaths(p)[0], l.Utilities.isAbsolutePath(p) || (p = this.options.baseUrl + p)), this._addUrlArgsIfNecessaryToUrl(p)
...
(function(l) {
    var E = function() {
            ...
            return r.prototype.load = function(e, t, i, o) {
                var u = this;
                ...
                this._callbackMap[t] = [f], this._scriptLoader.load(e, t, function() {
            ...
            return r.prototype._init = function(e) {
                ...
                if (!!i && !this._didPatchNodeRequire) {
                    ...
                    function s(f) {
                        ...
                        }, d.main = process.mainModule, d.extensions = c._extensions, d.cache = c._cache, d
                    }
                    u.prototype._compile = function(f, c) {
                        ...
                        try {
                            ...
                            m = I.slice(0, 16), y.cachedData = I.slice(16), v.record(60, g)
                        } catch (O) {
                            v.record(61, g)
                        }
                        ...
                        return o._handleCachedData(b, d, g, !y.cachedData, t), o._verifyCachedData(b, d, g, m, t), R
                    }
                }
            }, r.prototype.load = function(e, t, i, o) {
                var u = this,
                    ...
                    c = s.nodeInstrumenter || function(C) {
                        return C
                    };
                ...
                return g.amd = d.amd, c.call(l.global, e.getGlobalAMDRequireFunc(), g, i.filename, this._path.dirname(i.filename)), s.record(32, i.filename), v ? o() : u(new Error("Didn't receive define call in " + i.filename + "!")), f
                    ...
                    v = function() {
                        setTimeout(function() {
                            ...
                            if (!(g.length === 0 || g.length === f || c >= 5)) {
                                ...
                                f = g.length, u._fs.writeFile(i, Buffer.concat([d, g]), function(y) {
                ...
                if (!t) this._fs.readFile(e, {
                    ...
                    this._fs.readFile(e, {
                        ...
                        !v && g && g.length > 0 ? (f = g.slice(0, 16), s = g.slice(16), i.record(60, t)) : i.record(61, t), d()
                    })
                }
                ...
                !o || e.cachedDataRejected || setTimeout(function() {
                    ...
                    o.equals(f) || (u.getConfig().onError(new Error("FAILED TO VERIFY CACHED DATA, deleting stale '" + i + "' now, but a RESTART IS REQUIRED")), s._fs.unlink(i, function(c) {
...
(function(l) {
    var E = function() {
        ...
        return r._normalizeModuleId = function(e) {
            var t = e,
                i;
            ...
            var t = e;
            return l.Utilities.isAbsolutePath(t) || (l.Utilities.startsWith(t, "./") || l.Utilities.startsWith(t, "../")) && (t = r._normalizeModuleId(this.fromModulePath + t)), t
        }, r.ROOT = new r(""), r
    }();
    l.ModuleIdResolver = E;
    var h = function() {
        function r(e, t, i, o, u, s) {
            this.id = e, this.strId = t, this.dependencies = i, this._callback = o, this._errorback = u, this.moduleIdResolver = s, this.exports = {}, this.error = null, this.exportsPassedIn = !1, this.unresolvedDependenciesCount = this.dependencies.length, this._isComplete = !1
        }
        return r._safeInvokeFunction = function(e, t) {
            ...
            if (this._callback)
                if (typeof this._callback == "function") {
                    ...
                    o = u.producedError, e.record(22, this.strId), !o && typeof u.returnedValue != "undefined" && (!this.exportsPassedIn || l.Utilities.isEmpty(this.exports)) && (this.exports = u.returnedValue)
    ...
    var p = function() {
        ...
        return r.prototype.reset = function() {
            ...
            this._modules2[c] = d, this._config.isBuild() && (this._buildInfoDefineStack[c] = u, this._buildInfoDependencies[c] = (d.dependencies || []).map(function(v) {
            ...
            t ? this._config = new l.Configuration(this._env, e) : this._config = this._config.cloneAndMerge(e), this._config.shouldRecordStats() && !i && (this._recorder = null)
            ...
            if (i)
                for (var o = 0, u = i.length; o < u; o++) {
                    ...
                    if (this._hasDependencyPath(s.id, e.id)) {
                        this._hasDependencyCycle = !0, console.warn("There is a dependency cycle between '" + this._moduleIdProvider.getStrModuleId(s.id) + "' and '" + this._moduleIdProvider.getStrModuleId(e.id) + "'. The cyclic path follows:");
                        var c = this._findCyclePath(s.id, e.id, 0) || [];
                        c.reverse(), c.push(s.id), console.warn(c.map(function(g) {
...
`)), e.unresolvedDependenciesCount--;
            ...
            if (!e.isComplete()) {
                ...
                if (m) {
                    ...
                    for (var s = 0, f = m.length; s < f; s++) this._loadPluginDependency(e.exports, m[s])
                }
            }
        }, r
    }();
...
(function(l) {
    var E = new l.Environment,
        h = null,
        _ = function(r, e, t) {
            typeof r != "string" && (t = e, e = r, r = null), (typeof e != "object" || !Array.isArray(e)) && (t = e, e = null), e || (e = ["require", "exports", "module"]), r ? h.defineModule(r, e, t, null, null) : h.enqueueDefineAnonymousModule(e, t)
        };
    _.amd = {
        jQuery: !0
    };
    ...
    function p() {
        ...
        E.isNode && !E.isElectronRenderer ? (module.exports = n, require = n) : (E.isElectronRenderer || (l.global.define = _), l.global.require = n)
    }
    l.init = p, (typeof l.global.define != "function" || !l.global.define.amd) && (h = new l.ModuleManager(E, l.createScriptLoader(E), _, n, l.Utilities.getHighPerformanceTimestamp()), typeof l.global.require != "undefined" && typeof l.global.require != "function" && n.config(l.global.require), define = function() {
        return _.apply(null, arguments)
    }, define.amd = _.amd, typeof doNotInitLoader == "undefined" && p())
})(AMDLoader || (AMDLoader = {}));
